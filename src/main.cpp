...
#if defined(NDEBUG)
# error "Tradecoin cannot be compiled without assertions."
#endif
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Tradecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1491855910, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "Tradecoin you are a great coin you know";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 25 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("047ffa314e78ed600a9f1ead36565367eef01178d90a822520db0d1b738a5725cb8d6857acc7aa5eba860a915360974e7fabb98e44bed24c7118007cb9fdb08736") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1491855910;
        ...
        assert(block.hashMerkleRoot == uint256("0xadcbcd2a56717eb06afafdc7faa439a39da2737fdbdd93be73e1d8da77f47a4e"));
...
unsigned char pchMessageStart[4] = { 0x38, 0x97, 0x62, 0xba }; // Tradecoin: increase each by adding 2 to bitcoin's value.
